...
declare class LinuxRaspbianPlatform extends BasePlatform {
    /**
     ...
     * @returns {boolean} Boolean indicating success.
     */
    setWirelessMode(enabled: string, mode?: string, options?: Record<string, unknown>): boolean;
    /**
...
declare const _default: LinuxRaspbianPlatform;
export default _default;
//# sourceMappingURL=linux-raspbian.d.ts.map